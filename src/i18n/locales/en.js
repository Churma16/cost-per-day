const translation = {
  ...
  "planCount_one": "1 plan",
  "yourPlans": "Your Plans",
  "targetDate": "Target date",
  "targetDatePrefix": "Target {{date}}",
  "estimatedTargetPrefix": "Estimated target · {{date}}",
  "needsPace": "Estimated contribution ≈ {{daily}}/day",
  "targetDatePaceDetail": "{{daily}}/day · {{weekly}}/week · {{monthly}}/month",
  ...
  "reachedAroundDate": "reached {{date}}",
  "timeRemainingDays": "~{{days}} days remaining",
  "timeRemainingWeeks": "~{{weeks}} weeks remaining",
  "timeRemainingMonths": "~{{months}} months remaining",
  "approxDurationDays": "~{{days}} days",
  "approxDurationWeeks": "~{{weeks}} weeks",
  "approxDurationMonths": "~{{months}} months",
  "newEstimate": "New estimate: ~{{periods}} {{periodUnit}} ({{days}} days)",
  "newEstimateDays": "New estimate: ~{{days}} days",
  "previewUnsaved": "Preview, unsaved",
  "saved": "Saved",
  "apply": "Apply",
  "applyChanges": "Apply changes",
  "saving": "Saving...",
  "recurringContributionAdjustForCadence": "Recurring contribution (adjust for new frequency)",
