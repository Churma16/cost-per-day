const translation = {
  ...
  "benchmarkResultRequiredDuration": "To match your previous item's value ({{rate}}/day):",
  "benchmarkResultTargetDuration": "To match your previous target ({{rate}}/day):",
  "benchmarkResultDays": "~{{days}} days",
  "benchmarkResultDaysToBeat": "Past {{days}} days, its daily cost would be lower than your previous item's",
  "close": "Close",
  ...
  "benchmarkEmptyHint": "Enter a price above to calculate how long this purchase needs to last to match {{amount}}/day.",
